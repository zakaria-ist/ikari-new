...
function showTransactionModal() {
    ...
    // $('#amount_detail').css("display", "none");
...
function selectDistribution(id, code, name, account_id, account_code, account_name) {
    ...
    // $.ajax({
    //     method: "GET",
    //     url: '/accounting/taxByDisctibutor/'+id,
    //     dataType: 'JSON',
    //     data: {
...
function addTransaction() {
    ...
    if (validate != "success") {
        ...
        // var id_amount = float_format($("#id_amount").val());
        // var subtotal = float_format(id_amount + transaction.amount);
...
function editNewTransactionModal(line) {
    ...
    // $('#amount_detail').css("display", "block");
    // Add action to save button
...
function editOldTransaction(line) {
    ...
    if (validate == "success") {
        ...
        // datatbl.cell(row, $("#trs-amount").index()).data(transaction.amount.toFixed(2));
        // datatbl.cell(row, $("#trs-tax_amount").index()).data(transaction.tax_amount.toFixed(2));
        // datatbl.cell(row, $("#trs-total_amount").index()).data(transaction.total_amount.toFixed(2));
        // datatbl.draw();
