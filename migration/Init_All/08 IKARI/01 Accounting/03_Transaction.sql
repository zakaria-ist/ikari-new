...
-- set @company_id = 8; -- 3 = Crown, 4 = Nitto
...
SELECT CNTENTR code
    ...
    ,(SELECT id FROM accounting_paymentcode where code=PAYMCODE and source_type='AP'
...
SELECT CNTITEM code
    ...
    ,AMTRMIT payment_amount
    ,IDRMIT payment_check_number
    ,(SELECT id FROM accounting_paymentcode where code=CODEPAYM and source_type='AR'
        and company_id=@company_id) payment_code_id
    ,(CASE WHEN CODECURNBC='DOS' THEN
        (select id from currencies_currency where code='SGD')
      ELSE
